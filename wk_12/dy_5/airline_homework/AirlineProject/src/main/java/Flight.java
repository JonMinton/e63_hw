...
public class Flight {
    ...
    public Flight(ArrayList<Pilot> pilots, ArrayList<CabinCrewMember> crew, Plane plane, String flightNumber, AirportLocation departure, AirportLocation destination, String departureTime){
        this.pilots = pilots;
        this.crew = crew;
        this.plane = plane;
